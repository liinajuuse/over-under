...
level_key = c("_95" = "Happy", "083" = "Anger", 
              "091" = "Neutral", "079" = "Sad",
              "075" = "Surprise", "071" = "Disgust",
              "087" = "Fear", 
              "207" = "Sad", "203" = "Surprise", 
              "215" = "Fear", "223" = "Happy", 
              "211" = "Anger", "219" = "Neutral", 
              "199" = "Disgust",
              "039" = "Disgust", "055" = "Fear", 
              "051" = "Anger", "063" = "Happy",
              "043" = "Surprise", "059" = "Neutral",
              "047" = "Sad", 
              "187" = "Neutral", "179" = "Anger", 
              "167" = "Disgust", "191" = "Happy", 
              "175" = "Sad", "171" = "Surprise", 
              "183" = "Fear")
...
for (j in 1:length(fi)) {
  ...
  data_02$Condition <- ifelse(data_02$Marker %in% c("_95", "083", "091", "079", "075", "071", "087", "207", "203", "215", "223", "211", "219", "199"), "Over", "Under")
  data_02$Set <- ifelse(data_02$Marker %in% c("_95", "083", "091", "079", "075", "071", "087", "039", "055", "051", "063", "043", "059", "047"), "1", "2")  
  data_02$Emotion <- data_02$Marker
  data_02$Emotion <- recode(data_02$Emotion, !!!level_key)
  
  data_02 <- data_02[, c('Electrode', 'Subj', 'Group', 'Age', 'Sex', 'Marker', 'Condition', 'Set', 'Emotion', column.names)]
